...
import { registerCommand, registerGroupLabel } from './core/palette-registry'
...
import { PALETTE_CHORD, createCommandPalette } from './ui/commandpalette'
...
/** The catalogue id of the search field this file owns. The palette owns its own. */
