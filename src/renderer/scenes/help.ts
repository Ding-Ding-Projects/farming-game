...
const FOOTNOTE =
  'THE AXE CUTS BOTH WAYS: SWUNG AT ROCK, TIMBER OR WEEDS IT CLEARS THEM, AND ' +
  'SWUNG AT STANDING GRASS IT SCYTHES HAY INTO THE SILO. HAY IS CUT BEFORE ' +
  'WINTER, NEVER DURING IT, AND IT IS WHAT FEEDS THE ANIMALS WHEN NOTHING GRAZES. ' +
  'EVERY BUILDING HAS A DOOR: WALK UP TO IT AND USE IT TO GO INSIDE. ' +
